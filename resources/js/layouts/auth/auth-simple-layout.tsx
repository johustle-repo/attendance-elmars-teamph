...
const highlights = [
    {
        ...
        description: 'Camera, image upload, and manual fallback in one scanner.',
        icon: QrCode,
    },
    {
    ...
    },
    {
        ...
        description: 'Designed for daily attendance operations and admin control.',
        icon: LockKeyhole,
    },
];
...
export default function AuthSimpleLayout({
    ...
    return (
        <div className="min-h-svh bg-[linear-gradient(145deg,_#082f49_0%,_#0f766e_34%,_#f8fafc_34%,_#eff6ff_100%)] p-6 md:p-10">
            <div className="mx-auto grid min-h-[calc(100svh-3rem)] max-w-7xl overflow-hidden rounded-[2rem] border border-white/60 bg-white/88 shadow-2xl shadow-cyan-950/10 backdrop-blur lg:grid-cols-[1.05fr_0.95fr]">
                    ...
                    <div className="relative z-10 flex h-full flex-col">
                        ...
                        <div className="mt-14 max-w-xl space-y-5">
                            ...
                            <h2 className="text-5xl font-semibold tracking-tight">
                                QR-powered attendance for your team in one place.
                            </h2>
                            <p className="text-lg text-cyan-50/85">
                                Sign in to manage users, export attendance, and
                                keep named QR identity cards ready for every team
                                member.
                            </p>
                        </div>
